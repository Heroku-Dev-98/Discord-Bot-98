...
const { DefaultColor, prefix, token, avatarURL } = require('../config');
	...
	if (command === 'commands') {
		if (message.member.permissions.has('ADMINISTRATOR')) {
			const Adminembed = new Discord.RichEmbed()
				...
				.addField('Game Commands:', `${prefix}fortnite (user) (This returns with stats of the past 7 days)`)
				...
				.addField('Moderator Commands:', `${prefix}create-role ${prefix}ban ${prefix}kick`)
				.setTimestamp()
