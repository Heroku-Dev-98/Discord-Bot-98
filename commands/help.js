...
module.exports = {
	...
	execute(client, kayn, REGIONS, config, message, args, con, guilds) {
		const embed = new Discord.RichEmbed()
			...
			.addField('Other Commands:', `${prefix}messages ${prefix}start [Turns Bot Online] ${prefix}commands ${prefix}urban (word) ${prefix}dictionary (word) ${prefix}ping ${prefix}avatar ${prefix}invite-bot ${prefix}help ${prefix}speed ${prefix}beep ${prefix}login ${prefix}logout`);
